...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        с полученным списком питомцев, совпадающих с фильтром. На данный момент фильтр может иметь
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод публикует на сервер данные о добавляемом питомце и возвращает статус
    ...
    def add_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str,
                                  age: str) -> json:
        """Метод публикует на сервер данные о добавляемом питомца без фото и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленного питомца"""
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Метод отправляет запрос на сервер для обновления данных питомца по указанному ID и
